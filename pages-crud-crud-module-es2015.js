...
let FormBuscarPersonaComponent = class FormBuscarPersonaComponent {
...
FormBuscarPersonaComponent.ctorParameters = () => [
...
class CrudGridPersonasActions {
    constructor(getState, setState, personService) {
...
let CrudStore = class CrudStore extends _app_core_store_store__WEBPACK_IMPORTED_MODULE_3__["Store"] {
    constructor(personService) {
        super(new _crud_store_model__WEBPACK_IMPORTED_MODULE_1__["CrudStoreModel"]());
        this.personService = personService;
        this.actionModalPersonas = new _actions_modal_persona_action__WEBPACK_IMPORTED_MODULE_4__["CrudModalPersonaActions"](this.buildScopedGetState('modalPersona'), this.buildScopedSetState('modalPersona'), personService);
        this.actionGridPersonas = new _actions_grid_personas_action__WEBPACK_IMPORTED_MODULE_5__["CrudGridPersonasActions"](this.buildScopedGetState('gridPersonas'), this.buildScopedSetState('gridPersonas'), personService);
    }
};

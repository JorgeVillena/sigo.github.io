...
let AutorizacionesRoutingModule = class AutorizacionesRoutingModule {
};
...
let AutorizacionesModule = class AutorizacionesModule {
};
...
let JsonPlaceholderService = class JsonPlaceholderService {
    constructor(http) {
        ...
        this.fetchPosts = (userId) => {
            return this.http.get(`${this.url}/posts`, { params: { userId: userId } });
        };
        this.fetchComments = (postId) => {
            return this.http.get(`${this.url}/comments`, { params: { postId: postId } });
        };
    }
};
JsonPlaceholderService.ctorParameters = () => [
